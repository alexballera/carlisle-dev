...
module.exports = {
  template: yo`
    <picture class="content-picture about-why-picture row no-gutters justify-content-center" id="about-community">
    <img class="d-block img-fluid" src="${data.staff.lucy.avatar}" alt="" id="about-community-img">
